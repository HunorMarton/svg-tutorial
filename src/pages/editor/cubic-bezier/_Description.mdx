...
<Path title="M">
  <li>
    <div>
      <Input client:idle feature="cubicBezier" property="x0" type="number" />
      <Input client:idle feature="cubicBezier" property="y0" type="number" />
    </div>
  </li>
</Path>
...
<li>
  <div>
    <Input client:idle feature="cubicBezier" property="x" type="number" />
    <Input client:idle feature="cubicBezier" property="y" type="number" />
  </div>
