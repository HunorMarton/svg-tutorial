...
<SVG width="200" height="200" viewBox="-100 -100 200 200">
  ...
  <Circle cx="0" cy="20" r="70" fill="url(#shine)" data-element-id="circle-1" />
  <Circle
    cx="0"
    cy="-75"
    r="12"
    ...
    data-element-id="circle-2"
  />
  <Rect x="-17.5" y="-65" width="35" height="20" fill="#F79257" data-element-id="rect-1" />
</SVG>

{/* prettier-ignore */}
```html ins={6-22, 28 } /shine/
<svg
  width="200"
  height="200"
  viewBox="-100 -100 200 200"
