...
<SVG width="100" height="100" viewBox="0 0 200 200">
  <Circle cx="100" cy="100" r="50" data-element-id="circle-1" />
</SVG>
...
<SVG width="200" height="200" viewBox="-100 -100 200 200">
  <Circle cx="0" cy="0" r="50" data-element-id="circle-1" />
</SVG>
...
<Note>
  The SVG element often has an `xmlns` property as well. If the image is inlined
  in HTML this can be omitted.
</Note>
...
<SVG width="200" height="200" viewBox="-100 -100 200 200">
  <Circle cx="0" cy="20" r="70" fill="#D1495B" data-element-id="circle-1" />
</SVG>
