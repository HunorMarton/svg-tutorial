...
description: Learn how to set the control points when drawing a cubic Bézier curve with SVG. In this tutorial, we learn how to connect line segments with smooth curves and how to draw a profile icon and a gift box.
