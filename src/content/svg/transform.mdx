...
Then we create the back side of the lamp's shade from two [quadratic Bézier curves](/svg/quadratic-bezier). This one comes before the circle, because it is behind the light bulb.
