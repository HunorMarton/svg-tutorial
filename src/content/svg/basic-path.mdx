...
description: Learn how to draw basic shapes with the SVG path element. We draw a hamburger menu icon, a heart shape, and an arrow icon using the move-to and line-to commands.
