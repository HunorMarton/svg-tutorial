...
A smile is a simple image we can create using a quadratic Bezier curve. Look at this happy face! Here, the invisible control point is at the bottom of the image at `0,90`.
